...
public class QuestionActivity extends AppCompatActivity {
    ...
    /*
        The user may select the Delete action item from the app bar's action menu to delete the current question.
        Below shows deleteQuestion() method which calls the Question DAO method deleteQuestion() to delete the question from the database.
    */
